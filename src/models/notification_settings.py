...
from sqlalchemy import Boolean, Column, ForeignKey, Index, text, DateTime
...
class NotificationSettingsModel(Base):
    ...
    notify_group_assigned: Mapped[bool] = mapped_column(
    ...
    __table_args__ = (
        ...
        Index(
            "ix_notification_settings_weekly_report_enabled", "weekly_report_enabled"
        ),
        ...
        # Составные индексы
        Index(
            "ix_notification_settings_user_weekly", "user_id", "weekly_report_enabled"
        ),
