...
class TokenSchema(BaseModel):
    ...
    # Пароль сгенерирован автоматически (регистрация через Telegram-бота) и
    # ещё не менялся — фронтенд должен показать форму смены пароля перед
    # тем, как пускать дальше в приложение.
