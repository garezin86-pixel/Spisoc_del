...
async def cmd_voice_help(message: Message):
    ...
    text = (
        ...
        "\n"
        "Просто отправь голосовое сообщение — бот сам поймёт что нужно сделать.\n"
        "\n"
        "📌 <b>Создать задачу</b>\n"
        ...
        "\n"
        "🔍 <b>Найти задачу</b>\n"
        "Используй слова «найди», «покажи», «есть ли»:\n"
        "<i>«найди задачу про Илью»</i>\n"
        "<i>«покажи задачи про отчёт»</i>\n"
        "\n"
        "✅ <b>Изменить статус</b>\n"
        "Скажи что сделал или нужно сделать со статусом:\n"
        ...
        "Скажи «сделай срочной» или «повысь приоритет»:\n"
        "<i>«сделай задачу про отчёт срочной»</i>\n"
        "<i>«задача про встречу не срочная»</i>\n"
        "\n"
        "👤 <b>Назначить исполнителя</b>\n"
        "Скажи «назначь» и username пользователя:\n"
        "<i>«назначь задачу про договор пользователю maksim»</i>\n"
        "<i>«переназначь задачу про отчёт на aleksey»</i>\n"
        "\n"
        "💡 <b>Подсказка:</b> если в голосовом нет слов «найди», «назначь», "
        "«отметь», «статус», «приоритет» — бот автоматически <b>создаст задачу</b>."
    )
